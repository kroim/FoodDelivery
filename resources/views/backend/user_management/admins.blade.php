    ...
    <section class="content">
        <div class="content__inner">
            <header class="content__title">
                <h1>{{__('global.side.admins')}}</h1>
            </header>

            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{__('global.side.admins').' '.__('global.common.management')}}</h4>
                    <div class="actions">
                        <button class="btn btn-success" href="javascript:" onclick="$('#modal_add_user').modal('show')">{{ __('global.common.add').' '.__('global.side.admin') }}</button>
                    </div>
